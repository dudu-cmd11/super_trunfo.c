...
int main() {
    ...
    /*****Todas variáveis declaradas estão a baixo******/

    int carta1, carta2, pt1, pt2;
    ...
    /*****Aqui começa a interação com o jogador*****/
    /*****E também os dados da Primeira carta*****/
    ...
    /*****Aqui inicia o calculo de alguns atributos da primeira carta*****/
    ...
    /***** Já aqui seria a parte em que as informações colocadas pelo jogador seja exibida em tela *****/
    ...
    /*****  Aqui inicia a coleta de dados da segunda carta *****/
    ...
    /*****Aqui inicia o calculo de alguns atributos da segunda carta*****/
    ...
    printf("Agora iremos saber qual das cartas tem a maior população.\n");
    printf("%d - %s: %lu\n", carta1, cidade1, populacao1);
    printf("%d - %s: %lu\n", carta2, cidade2, populacao2);
    if (populacao1 > populacao2)
    {
    printf("A %d venceu - %s: %lu\n", carta1, cidade1, populacao1);
    }
    else
    {
    printf("A %d venceu - %s: %lu\n", carta2, cidade2, populacao2);
